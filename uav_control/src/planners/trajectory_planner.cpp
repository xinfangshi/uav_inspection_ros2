...
std::vector<Waypoint> TrajectoryPlanner::generate_trajectory(const Waypoint& start, const Waypoint& end, double T,
                                                             double dt) {
...
Eigen::VectorXd TrajectoryPlanner::solve_minimum_snap_1D(double start_p, double end_p, double T) {
    ...
    Q.insert(4, 5) = 1440.0 * std::pow(T, 2);
    Q.insert(5, 4) = 1440.0 * std::pow(T, 2);
    Q.insert(5, 5) = 4800.0 * std::pow(T, 3);
    Q.insert(4, 6) = 2880.0 * std::pow(T, 3);
    Q.insert(6, 4) = 2880.0 * std::pow(T, 3);
    Q.insert(6, 6) = 10800.0 * std::pow(T, 5);
    Q.insert(4, 7) = 5040.0 * std::pow(T, 4);
    Q.insert(7, 4) = 5040.0 * std::pow(T, 4);
    ...
    A.insert(4, 0) = 1.0;
    A.insert(4, 1) = T;
    A.insert(4, 2) = std::pow(T, 2);
    A.insert(4, 3) = std::pow(T, 3);
    A.insert(4, 4) = std::pow(T, 4);
    A.insert(4, 5) = std::pow(T, 5);
    A.insert(4, 6) = std::pow(T, 6);
    A.insert(4, 7) = std::pow(T, 7);  // 位置
    A.insert(5, 1) = 1.0;
    A.insert(5, 2) = 2 * T;
    A.insert(5, 3) = 3 * std::pow(T, 2);
    A.insert(5, 4) = 4 * std::pow(T, 3);
    A.insert(5, 5) = 5 * std::pow(T, 4);
    A.insert(5, 6) = 6 * std::pow(T, 5);
    A.insert(5, 7) = 7 * std::pow(T, 6);  // 速度
    A.insert(6, 2) = 2.0;
    A.insert(6, 3) = 6 * T;
    A.insert(6, 4) = 12 * std::pow(T, 2);
    A.insert(6, 5) = 20 * std::pow(T, 3);
    A.insert(6, 6) = 30 * std::pow(T, 4);
    A.insert(6, 7) = 42 * std::pow(T, 5);  // 加速度
    A.insert(7, 3) = 6.0;
    A.insert(7, 4) = 24 * T;
    A.insert(7, 5) = 60 * std::pow(T, 2);
    A.insert(7, 6) = 120 * std::pow(T, 3);
